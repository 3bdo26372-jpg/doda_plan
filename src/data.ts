...
export const exercises: Record<string, Exercise> = {
  ...
  overheadTri: { id:'overheadTri', name:'Cable Rope Overhead Triceps Extension', muscles:'Triceps', sets:'2 × 10–12', rest:'60 sec', equipment:'Cable machine / rope', cue:'Face away from the cable and step forward. Keep your elbows close to your head, then extend the rope overhead without arching your lower back.', gif:'/exercises/overhead-triceps.gif' },
